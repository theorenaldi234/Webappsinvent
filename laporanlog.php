...
<div class="card">
  ...
  <ul class="pagination pagination-sm">
    ...
    <li class="page-item"><a class="page-link" href="inlog.php">Detail Laporan</a></li>
  </ul>
</nav>
                        <thead>
                        <tr>
                        ...
                        <tbody>
                            <?php
                                $no=1;
                                $data_produk=mysqli_query($conn,"SELECT * FROM laporanlog l, printer e
                                WHERE  e.id_printer=l.id_printer ORDER BY idlaporan DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                            $itungtrans = mysqli_query($conn,"SELECT SUM(quantity) as jumlahtrans
                                             FROM tb_notalog where no_nota='$nota'");
                                        ...
                                        <td>
                                        <a class="btn btn-primary btn-xs" href="detaillog.php?invoice=<?php echo $nota ?>">
