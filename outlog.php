...
<div class="card">
  ...
  <ul class="pagination pagination-sm">
    <li class="page-item"><a class="page-link" href="laporancus.php">Laporan Out Logistik</a></li><li class="page-item active" aria-current="page">
      <span class="page-link">2</span>
                        ...
                        <tbody>
                            <?php
                                $no=1;
                                $data_produk=mysqli_query($conn,"SELECT * FROM tb_notacus l, produk e
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                                $itungtrans = mysqli_query($conn,"SELECT tgl_sub as jumlahtrans
                                                 FROM laporancus where no_nota='$nota'");
