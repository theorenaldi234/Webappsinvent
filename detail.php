...
$liatcust = mysqli_query($conn,"SELECT * FROM printer e, laporan c WHERE no_nota='$nota' and e.id_printer=c.id_printer");
...
<div class="row">
    ...
    <div class="col-sm-6">
        <p class="small mb-0">Lokasi Printer : <?php echo $checkdb['lokasi_printer'] ?></p>
        <p class="small mb-0">Tipe Printer : <?php echo $checkdb['tipe_printer'] ?></p>
        <p class="small mb-0">Lantai Printer : <?php echo $checkdb['lantai_printer'] ?></p>
    </div>
</div>
