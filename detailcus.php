...
$liatcust = mysqli_query($conn,"SELECT * FROM pelanggan e, laporancus c WHERE no_nota='$nota' and e.idpelanggan=c.idpelanggan");
$checkdb = mysqli_fetch_array($liatcust);
?>
<br>
<a href="laporancus.php" class="btn btn-light btn-xs px-3 py-2 mb-2" style="font-weight:500;"><i class="fa fa-chevron-left fa-xs"></i> Kembali</a>
<div class="row">
    <div class="col-sm-6">
    <h6 class="mb-0">Invoice : <?php echo $nota ?></h6>
        <p class="small mb-0">IT : <?php echo $checkdb['nama_kasir'] ?></p>
...
<table class="table table-sm table-bordered dt-responsive nowrap border-0" id="cart" width="100%">
                        ...
                        <tbody>
                            <?php
                                 $no=1;
                                 $data_produk=mysqli_query($conn,"SELECT * FROM tb_notacus t, produklog p
                                 ...
                                 while($d=mysqli_fetch_array($data_produk)){
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #dee2e6;"><?php echo $d['kode_produk'] ?></td>
