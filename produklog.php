...
<?php
            if(isset($_POST['tambahProduk']))
            {
                ...
                $tambahkat = mysqli_query($conn,"INSERT INTO produklog (idkategori,kode_produk,nama_produk,stock,harga_modal,harga_jual)
                ...
                $tambahkat = mysqli_query($conn,"INSERT INTO produk (idkategori,kode_produk,nama_produk,stock,harga_modal,harga_jual)
                 values ('$idkategori','$kodeproduk','$namaproduk','$stock','$harga_modal','$harga_jual')");
                if ($tambahkat){
                    echo '<script>alert("Berhasil Menambahkan Data");window.location="produklog.php"</script>';
                } else {
            ...
            if(isset($_POST['updateProduk'])){
                ...
                mysqli_query($conn,"UPDATE produklog SET
                ...
                idkategori='$idkategori',nama_produk='$namaproduk',kode_produk='$kodeproduk',
                stock='$stock',harga_modal='$harga_modal',harga_jual='$harga_jual' WHERE idproduk='$idproduk' ");
                echo '<script>alert("Berhasil Update prdouk");window.location="produklog.php"</script>';
            };
            ?>
<div class="card">
    <div class="card-header">
        <div class="card-tittle"><i class="fa fa-table me-2"></i> Stok Logistik
  ...
  <ul class="pagination pagination-sm">
    <li class="page-item">
      <a class="page-link" href="produk.php">Stock IT</a>
    </li>
    <li class="page-item active" aria-current="page"><span class="page-link">Stock Logistik</span></li>
  </ul>
</nav>
                        <thead>
                        <tr>
                        ...
                        <tbody>
                            <?php
                                $no=1;
                                $data_produk=mysqli_query($conn,"SELECT * FROM kategori k, produklog p WHERE k.idkategori=p.idkategori order by idproduk ASC");
...
<?php 
    if(!empty($_GET['hapus'])){
        $idproduk = $_GET['hapus'];
        $hapus_data = mysqli_query($conn, "DELETE FROM produklog WHERE idproduk='$idproduk'");
        if($hapus_data){
            echo '<script>alert("Berhasil Hapus Data Produk");window.location="produklog.php"</script>';
        } else {
...
<?php 
$query = mysqli_query($conn, "SELECT max(kode_produk) as kodeTerbesar FROM produklog");
    ...
    <form method="post">
      ...
      <div class="modal-body">
          <div class="form-group mb-2">
              ...
              <input type="text" name="kode_produk" class="form-control" value="<?php echo $nama_pelanggan;?>">
          </div>
          <div class="form-group mb-2">
              <label>Warna Toner :</label>
