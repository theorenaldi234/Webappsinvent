...
$liatcust = mysqli_query($conn,"SELECT * FROM printer e, laporanlog c WHERE no_nota='$nota' and e.id_printer=c.id_printer");
$checkdb = mysqli_fetch_array($liatcust);
?>
<br>
<a href="laporanlog.php" class="btn btn-light btn-xs px-3 py-2 mb-2" style="font-weight:500;"><i class="fa fa-chevron-left fa-xs"></i> Kembali</a>
<div class="row">
    <div class="col-sm-6">
...
<table class="table table-sm table-bordered dt-responsive nowrap border-0" id="cart" width="100%">
                        ...
                        <tbody>
                            <?php
                                 $no=1;
                                 $data_produk=mysqli_query($conn,"SELECT * FROM tb_notalog t, produklog p
