...
<?php
            if(isset($_POST['tambahProduk']))
            {
                ...
                $tambahkat = mysqli_query($conn,"INSERT INTO produk (idkategori,kode_produk,tipe_printer,nama_produk,stock,harga_modal,harga_jual)
                 values ('$idkategori','$kodeproduk','$tipe_printer','$namaproduk','$stock','$harga_modal','$harga_jual')");
                $tambahkat1 = mysqli_query($conn,"INSERT INTO produklog (idkategori,kode_produk,tipe_printer,nama_produk,stock,harga_modal,harga_jual)
                 values ('$idkategori','$kodeproduk','$tipe_printer','$namaproduk','$stock','$harga_modal','$harga_jual')");
                if ($tambahkat){
            ...
            if(isset($_POST['updateProduk'])){
                ...
                idkategori='$idkategori',nama_produk='$namaproduk',kode_produk='$kodeproduk',tipe_printer='$tipe_printer',
...
<div class="card">
    <div class="card-header">
        <div class="card-tittle"><i class="fa fa-table me-2"></i> Stok IT 
  ...
  <ul class="pagination pagination-sm">
    <li class="page-item active" aria-current="page">
      <span class="page-link">Stock IT</span>
    </li>
    <li class="page-item"><a class="page-link" href="produklog.php">Stock Logistik</a></li>
  </ul>
</nav>
                        <thead>
                        <tr>
